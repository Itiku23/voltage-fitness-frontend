  ...
  return (
    <div className="bg-black text-white min-h-screen">
      ...
      <section className="relative h-[75vh] flex items-end">
        ...
        <div className="relative z-10 p-6 pb-14 max-w-2xl">
          <h1 className="text-4xl sm:text-5xl font-extrabold mb-4">
            Athlete Conditioning
          </h1>

          <p className="text-gray-200 text-lg">
            Elite performance training built for speed, power, endurance,
      ...
      <section className="px-6 py-16 max-w-5xl mx-auto">
        ...
        <ul className="space-y-4 text-gray-300">
          ...
          <li>✔ Athletes who value discipline and structure</li>
        </ul>

        <h2 className="text-2xl font-bold mt-14 mb-6 text-green-500">
          Training Focus
        </h2>
